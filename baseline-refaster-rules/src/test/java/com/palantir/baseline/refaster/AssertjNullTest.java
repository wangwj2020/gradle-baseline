    ...
    public void test() {
        RefasterTestHelper
                ...
                .withInputLines(
                        ...
                        "    assertThat(obj == null).as(\"desc\").isTrue();",
                        "    assertThat(obj != null).as(\"desc\").isFalse();",
                        "    assertThat(Objects.isNull(obj)).as(\"desc\").isTrue();",
                        "    assertThat(Objects.nonNull(obj)).as(\"desc\").isFalse();",
                        "    assertThat(obj == null).as(\"desc\").isFalse();",
                        "    assertThat(obj != null).as(\"desc\").isTrue();",
                        "    assertThat(Objects.isNull(obj)).as(\"desc\").isFalse();",
                        "    assertThat(Objects.nonNull(obj)).as(\"desc\").isTrue();",
                        "  }",
                        "}")
                .hasOutputLines(
                        "import static org.assertj.core.api.Assertions.assertThat;",
                        ...
                        "    assertThat(obj).isNotNull();",
                        "    assertThat(obj).isNotNull();",
                        "    assertThat(obj).as(\"desc\").isNull();",
                        "    assertThat(obj).as(\"desc\").isNull();",
                        "    assertThat(obj).as(\"desc\").isNull();",
                        "    assertThat(obj).as(\"desc\").isNull();",
                        "    assertThat(obj).as(\"desc\").isNotNull();",
                        "    assertThat(obj).as(\"desc\").isNotNull();",
                        "    assertThat(obj).as(\"desc\").isNotNull();",
                        "    assertThat(obj).as(\"desc\").isNotNull();",
                        "  }",
